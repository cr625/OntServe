...
def test_loop_repairs_cross_category_with_tier0():
    ...
    # domain core:Obligation; promoted intermediate -> core in v2.8.0, the
    # deprecated intermediate twin deleted 2026-07-04, 3e66802) is present.
    # Tier-0 defers to the property domain -> strips the Principle-chained type,
    # re-types core:Obligation.
